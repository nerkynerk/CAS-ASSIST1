...
8. Ask a verified-source question; show citation and resolution feedback.
9. Select “No,” review copied context, choose category/attachments, and submit exactly once.
...
1. Confirm no advising-management or AI access.
...
1. Confirm advising/announcement access and no student chatbot.
...
3. Show queue analytics with units, history-derived distribution, trends, peaks, and congestion.
